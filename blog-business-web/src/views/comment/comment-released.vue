...
<template>
    ...
    <div style="margin-top: 10px">
      <el-form :inline="true" :model="queryInfo" class="demo-form-inline">
        ...
        <el-form-item label="TargetPage">
          <el-input v-model="queryInfo.targetId" placeholder="Type Target Page"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <!--评论展示列表-->
		<el-table :data="commentList" row-key="id" :tree-props="{children: 'replyComments'}">
			<el-table-column label="ParentId" prop="id" width="130" show-overflow-tooltip></el-table-column>
			<el-table-column label="Name" prop="name" width="80" show-overflow-tooltip></el-table-column>
			<el-table-column label="Email" prop="email" show-overflow-tooltip width="150"></el-table-column>
      <!--<el-table-column label="ReplyWho" prop="replyWho" width="100"></el-table-column>-->
      <el-table-column label="Content" prop="content" show-overflow-tooltip width="400"></el-table-column>
      <el-table-column label="TargetPage" prop="targetId" width="130" show-overflow-tooltip>
        <!--跳转到评论所在页面-->
      ...
      <el-table-column label="Replies" width="100">
        <template v-slot="scope">
          <el-button type="primary" :disabled="scope.row.replyList.length<=0" @click="repliesHandler(scope.row.replyList)">Replies</el-button>
        </template>
      </el-table-column>
    ...
    <!-- 子评论查看对话框 -->
    <!-- TODO 存在的问题：编辑子评论后，在Replies对话框不能即时看到更改，需要关闭后再打开才能看到 -->
    <el-dialog title="Relies" width="80%" :visible.sync="replyDialogVisible" :close-on-click-modal="false">
      <el-table :data="commentReplyList" row-key="id" :tree-props="{children: 'replyComments'}">
        <el-table-column label="No" type="index" width="50"></el-table-column>
        <el-table-column label="Name" prop="name" width="80"></el-table-column>
        <el-table-column label="Email" prop="email" show-overflow-tooltip width="80"></el-table-column>
        <el-table-column label="Link" prop="link" show-overflow-tooltip width="80"></el-table-column>
        <el-table-column label="IP" prop="ip" show-overflow-tooltip width="80"></el-table-column>
        <el-table-column label="ReplyWho" prop="replyWho" width="100" show-overflow-tooltip></el-table-column>
        <el-table-column label="Content" prop="content" show-overflow-tooltip width="300"></el-table-column>
	...
	export default {
		...
		data() {
          ...
          targetId: undefined,
				...
				total: 0,
				commentList: [], //父评论
        commentReplyList: [], //某个评论下的所有子评论
				editDialogVisible: false,
        replyDialogVisible: false, //是否显示子评论的对话框
				editForm: {
					id: '',
					name: '',
					email: '',
        ...
        let param = {
          "data": {
            ...
            "condition": {
              "released": true, //已审核过了的、已发布的
              "deleted": false, //未删除的
            }
          }
        }
        commentApi.fetchListByHierarchy(param).then(res => {
        ...
        let param = {
          "data": {
            ...
            "condition": {
              ...
              "targetId": this.queryInfo.targetId,
              "released": true, //已审核过了的、已发布的
              "deleted": false, //未删除的
            }
          }
      ...
      repliesHandler(replyList) {
        this.replyDialogVisible = true
        this.commentReplyList = replyList
      },
		}
	}
</script>
