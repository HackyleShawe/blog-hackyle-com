<template>
  <div>
    ...
    <div style="margin-top: 10px">
      <el-form :inline="true" :model="queryInfo" class="demo-form-inline">
        <el-form-item label="Group">
          <el-input v-model="queryInfo.group" placeholder="Type Config Group"></el-input>
        </el-form-item>
        <el-form-item label="Name">
          <el-input v-model="queryInfo.name" placeholder="Type Config Name"></el-input>
        </el-form-item>
        <el-form-item label="key">
          <el-input v-model="queryInfo.key" placeholder="Type Config Key"></el-input>
        </el-form-item>
    ...
    <el-table :data="configList" row-key="id">
      ...
      <el-table-column label="Group" prop="configGroup" width="110" show-overflow-tooltip></el-table-column>
      <el-table-column label="Name" prop="name" width="110" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="Add New Config" width="50%" :visible.sync="addDialogVisible" :close-on-click-modal="false" @close="addDialogClosed">
      ...
      <el-form :model="addForm" :rules="formRules" ref="addFormRef" label-width="100px">
        <el-form-item label="Group" prop="configGroup">
          <el-input v-model="addForm.configGroup"></el-input>
        </el-form-item>
    ...
    <el-dialog title="Edit Link" width="50%" :visible.sync="editDialogVisible" :close-on-click-modal="false" @close="editDialogClosed">
      <el-form :model="editForm" :rules="formRules" ref="editFormRef" label-width="100px" @close="editDialogClosed">
        <el-form-item label="Group" prop="configGroup">
          <el-input v-model="editForm.configGroup"></el-input>
        </el-form-item>
        <el-form-item label="Name" prop="name">
...
export default {
  ...
  data() {
    return {
      ...
      formRules: {
        configGroup: [{required: true, message: 'Please Input Config Group', trigger: 'blur'}],
    ...
    search() {
      let param = {
        "data": {
          ...
          "pageSize": this.queryInfo.pageSize,
          "condition": {
            "configGroup": this.queryInfo.group,
            "name": this.queryInfo.name,
            "configKey": this.queryInfo.key,
    ...
    addNewConfig() {
      this.$refs.addFormRef.validate(valid => {
        if (valid) {
          let param = {
            "data": {
              "configGroup": this.addForm.configGroup,
      ...
      this.$refs.editFormRef.validate(valid => {
        if (valid) {
          const param = {
            "data": {
              "id": this.editForm.id,
              "configGroup": this.editForm.configGroup,
