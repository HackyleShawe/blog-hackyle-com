...
<template>
  <div>
    ...
    <el-table :data="commentList" row-key="id" :tree-props="{children: 'replyComments'}">
      ...
      <!--<el-table-column label="IP" prop="ip" width="100" show-overflow-tooltip></el-table-column>-->
      ...
      <el-table-column label="ParentId" prop="parentId" show-overflow-tooltip width="130">
        <!--跳转到评论所在页面-->
