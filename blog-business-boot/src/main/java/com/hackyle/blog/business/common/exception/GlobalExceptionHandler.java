...
public class GlobalExceptionHandler {
    ...
    @ResponseBody
    public ApiResponse<String> exceptionHandler(HttpServletRequest request, TokenException tokenException) throws Exception {
        logger.error("出现TokenException异常：exception=", tokenException);

        return ApiResponse.error(ResponseEnum.SIGN_IN_FAIL.getCode(), ResponseEnum.SIGN_IN_FAIL.getMessage(), tokenException.getMessage());
    }
